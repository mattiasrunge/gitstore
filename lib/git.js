...
module.exports.init = co(function*(hostname, dir) {
    ...
    for (let name of items) {
        module.exports.info[name] = yield module.exports.info(name);
    }
});
...
module.exports.info = co(function*(name) {
    ...
    return {
        hash: hash,
        date: moment(timestamp * 1000).format(),
        author: author,
        subject: subject
    };
});
...
module.exports.list = co(function*() {
    let items = Object.keys(module.exports.info);

    return items.map(name => {
        return {
            name: name,
            uri: module.exports.uri(name),
            info: module.exports.info[name]
        }
    });
});
